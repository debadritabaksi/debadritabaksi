...
I am a B.Tech CSE student, 3x hackathon dominator, and UI/UX frontend architect specializing in high-performance digital ecosystems. Experienced in engineering enterprise-grade AI forensic dashboards, decentralized IoT navigation interfaces, and multi-agent intelligence platforms. Proficient in translating complex system logic into intuitive user experiences, bridging interactive React and WebGL frontends with robust Python and C-based backend infrastructure to solve real-world engineering challenges.
...
* Interactive 3D Web Rendering & Digital Asset Creation
* Backend Logic Design & Full-Stack Architecture
* Competitive Hackathon Sprints & Tech Community Building
